...
// static
federated::BraveFederatedService*
BraveFederatedServiceFactory::GetForBrowserContext(
    content::BrowserContext* context) {
  if (base::FeatureList::IsEnabled(
          brave::federated::features::kFederatedLearning)) {
    return static_cast<federated::BraveFederatedService*>(
...
KeyedService* BraveFederatedServiceFactory::BuildServiceInstanceFor(
  ...
  std::unique_ptr<federated::BraveFederatedService> brave_federated_service(
      new federated::BraveFederatedService(
...
void BraveFederatedServiceFactory::RegisterProfilePrefs(
  ...
  federated::BraveFederatedService::RegisterProfilePrefs(registry);
}
